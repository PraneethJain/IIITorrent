...
class TorrentManager:
    ...
    async def run(self):
        ...
        self._tasks += [
            asyncio.ensure_future(self._execute_keeping_alive()),
            asyncio.ensure_future(self._execute_regular_announcements()),
            asyncio.ensure_future(self._execute_uploading()),
